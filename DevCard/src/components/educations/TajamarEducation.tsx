...
export const TajamarEducation: React.FC<EducationProps> = ({ educations }) => {

    const [open, setOpen] = useState(false);

    const toggle = () => setOpen(prev => !prev)

    const tajamareducation = educations.filter(
        (p: Education) => p.slug === "tajamar"
    );
            ...
            >
                ...
                <ModalBody className="myModalBody">
                    ...
                    <ul className="list-unstyled mb-0">
                        {tajamareducation.map((e: Education) => (
