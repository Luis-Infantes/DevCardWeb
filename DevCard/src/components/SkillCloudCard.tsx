...
import type { SkillCloudProps, skillCloud } from "../types/types";
import { Button, Modal, ModalBody, ModalHeader, ModalFooter, Badge } from 'reactstrap';


export const SkillCloudCard: React.FC<SkillCloudProps> = ({ skillsCloud }) => {
    ...
    return (
        ...
        <>
            ...
            >
                ...
                <ModalHeader  className="myModalHeader">Cloud Skills</ModalHeader>

                <ModalBody className="myModalBody">

                    <ul className="list-unstyled mb-0">
                        {skillsCloud.map((skill: skillCloud) => (
