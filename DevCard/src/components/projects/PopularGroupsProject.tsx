...
export const PopularGroupsProject: React.FC<ProjectPrimerProps> = ({ projectsprimer }) => {
    ...
    const populargroupsProject = projectsprimer.filter(
        (p: ProjectPrimer) => p.slug === "populargroups"
    );
    ...
    return (
        ...
        <div className="container">
            ...
            <Button className="Project-Style" onClick={toggle}>
                ...
                <p>Introductory exercise to develop using MVC and ASP.NET</p>
                <p className="text-info mb-2 fw-bold"> MVC | ASP.NET</p>
            </Button>
            ...
            >
                ...
                <ModalBody className="myModalBody">
                    ...
                    <ul className="list-unstyled mb-0">
                        {populargroupsProject.map((p: ProjectPrimer) => (
