...
export const SocialHomeProject: React.FC<ProjectPrimerProps> = ({ projectsprimer }) => {
    ...
    const socialhomeProject = projectsprimer.filter(
        (p: ProjectPrimer) => p.slug === "socialhome"
    );
    ...
    return (
        ...
        <div className="container">
            ...
            <Button className="Project-Style" onClick={toggle}>
                <h4>Social Home</h4>
                <p>Community homeowners association management application (in progress)</p>
                <p className="text-info mb-2 fw-bold">JavaScript</p>
            </Button>
            ...
            >
                ...
                <ModalBody className="myModalBody">
                    ...
                    <ul className="list-unstyled mb-0">
                        {socialhomeProject.map((p: ProjectPrimer) => (
