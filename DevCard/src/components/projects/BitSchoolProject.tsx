...
export const BitSchoolProject: React.FC<ProjectProps> = ({ projects }) => {
    ...
    const bitchoolProject = projects.filter(
        (p: Project) => p.slug === "bitschool"
    );
    ...
    return (
        ...
        <div className="container">
            ...
            <Button className="Project-Style" onClick={toggle}>
                <h4>Bit-School</h4>
                <p>Course academy project with CRUD operations</p>
