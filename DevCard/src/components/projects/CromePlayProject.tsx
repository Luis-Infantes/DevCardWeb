...
export const CromePlayProject: React.FC<ProjectProps> = ({ projects }) => {
    ...
    const cromeplayProject = projects.filter(
        (p: Project) => p.slug === "cromeplay"
    );
    ...
    return (
        ...
        <div className="container">
            ...
            <Button className="Project-Style" onClick={toggle}>
                <h4>Crome Play</h4> 
                <p>Event management and board game booking project</p>
                <p className="text-info mb-2 fw-bold"> MVC | ASP.NET Core| JavaScript</p>
            </Button>
            ...
            >
                ...
                <ModalBody className="myModalBody">
                    ...
                    <ul className="list-unstyled mb-0">
                        {cromeplayProject.map((p: Project) => (
