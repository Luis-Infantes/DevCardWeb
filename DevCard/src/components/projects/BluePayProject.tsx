...
export const BluePayProject: React.FC<ProjectCloudProps> = ({ projectscloud }) => {
    ...
    const bluepayProject = projectscloud.filter(
        (p: ProjectCloud) => p.slug === "bluepay"
    );
    ...
    return (
        ...
        <div className="container">
            ...
            <Button className="Project-Style" onClick={toggle}>
                <h4>Blue Pay </h4>
                <p>Transfer management with deployment on Azure</p>
                <p className="text-info mb-2 fw-bold">MVC | Azure</p>
            </Button>
            ...
            >
                ...
                <ModalBody className="myModalBody">
                    ...
                    <ul className="list-unstyled mb-0">
                        {bluepayProject.map((p: ProjectCloud) => (
